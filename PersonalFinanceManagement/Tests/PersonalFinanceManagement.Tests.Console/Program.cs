...
var fixture = new TestInMemoryFixture();
...
public class TestInMemoryFixture : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        await FillDbTestData();
    }

    private async Task FillDbTestData()
    {
        //using var transactionScope = new TransactionScope(TransactionScopeAsyncFlowOption.Enabled);

        using var transaction = await TestDbContext.Database.BeginTransactionAsync();
